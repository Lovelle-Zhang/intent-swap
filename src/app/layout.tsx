...
export const metadata: Metadata = {
  ...
  description: "Let AI agents spend money inside user-defined rules — every payment authorized against your policy and verified on-chain that it really happened. Test mode on Base Sepolia; ZenFix never holds funds or keys.",
