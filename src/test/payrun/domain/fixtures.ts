...
export function buildBudgetReservation(
  ...
  return {
    ...
    budgetKeys: [`project:${PROJECT_ID}`, "agent:agent_001", "merchant:merchant_known"],
...
export function buildApprovalRequest(
  ...
  return {
    ...
    generation: 1,
    requester: { actorId: "requester_agent_001", actorType: "agent" },
    ...overrides,
  };
}
...
export function buildApprovalDecision(
  ...
  return {
    ...
    approver: { actorId: "reviewer_server_context", actorType: "user" },
...
export function buildFundingPreparation(
  ...
  return {
    ...
    projectId: PROJECT_ID,
    payRunId: PAY_RUN_ID,
    budgetReservationId: "reservation_001",
