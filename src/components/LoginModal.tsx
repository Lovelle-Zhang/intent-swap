          ...
          {step === "choose" ? (
            <>
              ...
              <button
                ...
                disabled={busy}
                className="w-full py-3 rounded-xl bg-stone-900 hover:bg-stone-800 border border-stone-800 hover:border-stone-700 text-stone-200 text-sm transition-colors flex items-center justify-center gap-2.5 disabled:opacity-50"
              >
              ...
              <div className="flex items-center gap-3 my-5">
                ...
                <span className="text-stone-600 text-[10px] tracking-widest uppercase">or</span>
                <div className="flex-1 h-px bg-stone-800" />
              </div>

              {/* Email */}
              <form onSubmit={handleSendCode}>
                <div className="flex items-center bg-stone-900/40 border border-stone-800 hover:border-stone-700 rounded-xl overflow-hidden focus-within:border-gold-500/30 transition-colors">
                  <input
                    type="email"
                    value={email}
                    ...
                    disabled={busy}
                    autoComplete="email"
                    className="flex-1 bg-transparent px-4 py-2.5 text-stone-200 text-sm placeholder:text-stone-600 outline-none disabled:opacity-50"
                  />
                  <button
                    type="submit"
                    disabled={busy || !email.trim()}
                    className="px-4 py-2.5 text-gold-400 hover:text-gold-300 text-xs tracking-wider transition-colors disabled:opacity-30 disabled:hover:text-gold-400"
                  >
                    {busy ? "..." : "Send code →"}
                  </button>
                </div>
              ...
              <button
                ...
                className="w-full mt-4 py-2.5 text-stone-500 hover:text-stone-300 text-xs tracking-wide transition-colors"
              >
                I have a wallet →
              </button>
              ...
              <p className="mt-5 text-stone-700 text-[10px] text-center tracking-wide">
