...
const INTRO_SECTIONS: readonly DocSection[] = [
  ...
  },
  {
    ...
    <ol>
      ...
      <li><b>Policy.</b> On <a class="link" href="/zenfix/policy">Policy</a>, add your merchant to <i>Allowed merchants</i> and set limits/budget. <b>Pin the merchant&rsquo;s payout address</b> under <i>Merchant payout addresses</i> (<span class="mono">merchantId = 0x…</span>) — required to earn the <b>Verified on-chain</b> badge; the transfer is checked against this address.</li>
